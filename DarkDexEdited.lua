	...
	Explorer.InitRightClick = function()
		...
		context:Register("SAVE_INST",{Name = "Save to File", IconMap = Explorer.MiscIcons, Icon = "Save", OnClick = function()
			save.MouseButton1Click:Connect(function()
				...
				local filename = "Place_"..game.PlaceId..os.time()..".rbxl"
				local filename2 = "Place_"..game.PlaceId..os.time()..".rbxm"

				writefile(filename,source)
				if movefileas then -- TODO: USE ENV
					movefileas(filename,filename2, ".rbxm",".rbxl")
				end
			end)
		end})
...
local function main()
	...
	ScriptViewer.ViewScript = function(scr)
		...
		ViewScript.OnServerEvent:Connect(function(player, editedScript)
			ViewScript:FireAllClients(editedScript)
		end)
		window:Show()
	end
...
Main = (function()
	...
	Main.InitEnv = function()
		...
		env.protectgui = protect_gui or (krnl and krnl.protect_gui)
		env.gethui = gethui
